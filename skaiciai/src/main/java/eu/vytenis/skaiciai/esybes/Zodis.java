...
public class Zodis {
	...
	static {
		...
		skaiciai.put(2L, new Zodis("du", "dviejų", "dviem", "du", "dviem", "dviejuose", "du").kitasDgsVard());
		...
		skaiciai.put(10L, new Zodis("dešimt").kitasDgsKilm());		
		skaiciai.put(11L, new Zodis("vienuolika").kitasDgsKilm());
		skaiciai.put(12L, new Zodis("dvylika").kitasDgsKilm());
		skaiciai.put(13L, new Zodis("trylika").kitasDgsKilm());
		skaiciai.put(14L, new Zodis("keturiolika").kitasDgsKilm());
		skaiciai.put(15L, new Zodis("penkiolika").kitasDgsKilm());
		skaiciai.put(16L, new Zodis("šešiolika").kitasDgsKilm());
		skaiciai.put(17L, new Zodis("septyniolika").kitasDgsKilm());
		skaiciai.put(18L, new Zodis("aštuoniolika").kitasDgsKilm());
		skaiciai.put(19L, new Zodis("devyniolika").kitasDgsKilm());
		skaiciai.put(20L, new Zodis("dvidešimt").kitasDgsKilm());		
		skaiciai.put(30L, new Zodis("trisdešimt").kitasDgsKilm());
		skaiciai.put(40L, new Zodis("keturiasdešimt").kitasDgsKilm());
		skaiciai.put(50L, new Zodis("penkiasdešimt").kitasDgsKilm());
		skaiciai.put(60L, new Zodis("šešiasdešimt").kitasDgsKilm());
		skaiciai.put(70L, new Zodis("septyniasdešimt").kitasDgsKilm());
		skaiciai.put(80L, new Zodis("aštuoniasdešimt").kitasDgsKilm());
		skaiciai.put(90L, new Zodis("devyniasdešimt").kitasDgsKilm());		
