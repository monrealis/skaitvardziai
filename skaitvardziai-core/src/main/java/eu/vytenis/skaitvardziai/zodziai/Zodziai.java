...
public class Zodziai {
	...
	static {
		...
		Map<Long, Zodis> kuopiniai = new BigIntegerToLongBridgeMap<Long, Zodis>();
		Map<Long, Zodis> dauginiaiMotGim = new BigIntegerToLongBridgeMap<Long, Zodis>();
		Map<Long, Zodis> dauginiaiVyrGim = new BigIntegerToLongBridgeMap<Long, Zodis>();
		...
		pagrindiniaiVyrGim.put(20L, new Zodis("dvidešimt", "dvidešimties", "dvidešimčiai", "dvidešimtį", "dvidešimčia", "dvidešimtyje", "dvidešimt").kitasDgsKilm().nekaitomasLinksniuojant());		
		pagrindiniaiVyrGim.put(30L, new Zodis("trisdešimt", "trisdešimties", "trisdešimčiai", "trisdešimtį", "trisdešimčia", "trisdešimtyje", "trisdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(40L, new Zodis("keturiasdešimt", "keturiasdešimties", "keturiasdešimčiai", "keturiasdešimtį", "keturiasdešimčia", "keturiasdešimtyje", "keturiasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(50L, new Zodis("penkiasdešimt", "penkiasdešimties", "penkiasdešimčiai", "penkiasdešimtį", "penkiasdešimčia", "penkiasdešimtyje", "penkiasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(60L, new Zodis("šešiasdešimt", "šešiasdešimties", "šešiasdešimčiai", "šešiasdešimtį", "šešiasdešimčia", "šešiasdešimtyje", "šešiasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(70L, new Zodis("septyniasdešimt", "septyniasdešimties", "septyniasdešimčiai", "septyniasdešimtį", "septyniasdešimčia", "septyniasdešimtyje", "septyniasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(80L, new Zodis("aštuoniasdešimt", "aštuoniasdešimties", "aštuoniasdešimčiai", "aštuoniasdešimtį", "aštuoniasdešimčia", "aštuoniasdešimtyje", "aštuoniasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());
		pagrindiniaiVyrGim.put(90L, new Zodis("devyniasdešimt", "devyniasdešimties", "devyniasdešimčiai", "devyniasdešimtį", "devyniasdešimčia", "devyniasdešimtyje", "devyniasdešimt").kitasDgsKilm().nekaitomasLinksniuojant());		
		...
		kelintiniaiIvMotGim.put(3L, new Zodis("trečioji", "trečiosios", "trečiajai", "trečiąją", "trečiąja", "trečiojoje", "trečioji", "trečiosios", "trečiųjų", "trečiosioms", "trečiąsias", "trečiosiomis", "trečiosiose", "trečiosios"));
		...
		kelintiniaiIvMotGim.put(20L, new Zodis("dvidešimtoji", "dvidešimtosios", "dvidešimtajai", "dvidešimtąją", "dvidešimtąja", "dvidešimtojoje", "dvidešimtoji", "dvidešimtosios", "dvidešimtųjų", "dvidešimtosioms", "dvidešimtąsias", "dvidešimtosiomis", "dvidešimtosiose", "dvidešimtosios"));		
		kelintiniaiIvMotGim.put(30L, new Zodis("trisdešimtoji", "trisdešimtosios", "trisdešimtajai", "trisdešimtąją", "trisdešimtąja", "trisdešimtojoje", "trisdešimtoji", "trisdešimtosios", "trisdešimtųjų", "trisdešimtosioms", "trisdešimtąsias", "trisdešimtosiomis", "trisdešimtosiose", "trisdešimtosios"));
		kelintiniaiIvMotGim.put(40L, new Zodis("keturiasdešimtoji", "keturiasdešimtosios", "keturiasdešimtajai", "keturiasdešimtąją", "keturiasdešimtąja", "keturiasdešimtojoje", "keturiasdešimtoji", "keturiasdešimtosios", "keturiasdešimtųjų", "keturiasdešimtosioms", "keturiasdešimtąsias", "keturiasdešimtosiomis", "keturiasdešimtosiose", "keturiasdešimtosios"));
		kelintiniaiIvMotGim.put(50L, new Zodis("penkiasdešimtoji", "penkiasdešimtosios", "penkiasdešimtajai", "penkiasdešimtąją", "penkiasdešimtąja", "penkiasdešimtojoje", "penkiasdešimtoji", "penkiasdešimtosios", "penkiasdešimtųjų", "penkiasdešimtosioms", "penkiasdešimtąsias", "penkiasdešimtosiomis", "penkiasdešimtosiose", "penkiasdešimtosios"));
		kelintiniaiIvMotGim.put(60L, new Zodis("šešiasdešimtoji", "šešiasdešimtosios", "šešiasdešimtajai", "šešiasdešimtąją", "šešiasdešimtąja", "šešiasdešimtojoje", "šešiasdešimtoji", "šešiasdešimtosios", "šešiasdešimtųjų", "šešiasdešimtosioms", "šešiasdešimtąsias", "šešiasdešimtosiomis", "šešiasdešimtosiose", "šešiasdešimtosios"));
		kelintiniaiIvMotGim.put(70L, new Zodis("septyniasdešimtoji", "septyniasdešimtosios", "septyniasdešimtajai", "septyniasdešimtąją", "septyniasdešimtąja", "septyniasdešimtojoje", "septyniasdešimtoji", "septyniasdešimtosios", "septyniasdešimtųjų", "septyniasdešimtosioms", "septyniasdešimtąsias", "septyniasdešimtosiomis", "septyniasdešimtosiose", "septyniasdešimtosios"));
		kelintiniaiIvMotGim.put(80L, new Zodis("aštuoniasdešimtoji", "aštuoniasdešimtosios", "aštuoniasdešimtajai", "aštuoniasdešimtąją", "aštuoniasdešimtąja", "aštuoniasdešimtojoje", "aštuoniasdešimtoji", "aštuoniasdešimtosios", "aštuoniasdešimtųjų", "aštuoniasdešimtosioms", "aštuoniasdešimtąsias", "aštuoniasdešimtosiomis", "aštuoniasdešimtosiose", "aštuoniasdešimtosios"));
		kelintiniaiIvMotGim.put(90L, new Zodis("devyniasdešimtoji", "devyniasdešimtosios", "devyniasdešimtajai", "devyniasdešimtąją", "devyniasdešimtąja", "devyniasdešimtojoje", "devyniasdešimtoji", "devyniasdešimtosios", "devyniasdešimtųjų", "devyniasdešimtosioms", "devyniasdešimtąsias", "devyniasdešimtosiomis", "devyniasdešimtosiose", "devyniasdešimtosios"));
		kelintiniaiIvMotGim.put(100L, new Zodis("šimtoji", "šimtosios", "šimtajai", "šimtąją", "šimtąja", "šimtojoje", "šimtoji", "šimtosios", "šimtųjų", "šimtosioms", "šimtąsias", "šimtosiomis", "šimtosiose", "šimtosios"));		
