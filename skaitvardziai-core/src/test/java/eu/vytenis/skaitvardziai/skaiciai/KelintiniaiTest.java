...
public abstract class KelintiniaiTest extends SkaitvardziaiTest {
	...
	public void testVirst1000BigIntegers(Gimine gimine, Linksnis linksnis) {
		...
		combinedNumbers.put(BigInteger.valueOf(204).multiply(e3).multiply(e9).add(new BigInteger("652874250")), "du šimtai keturi tūkstančiai milijardų "
				+ prefix + "penkiasdešimtasis");
	...
	private void replaceToLinksnis(Linksnis linksnis, Map<BigInteger, String> map) {
