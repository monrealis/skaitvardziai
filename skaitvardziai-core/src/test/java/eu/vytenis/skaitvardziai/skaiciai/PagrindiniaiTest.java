...
public abstract class PagrindiniaiTest extends SkaitvardziaiTest {
	...
	protected void testSkaiciai(Map<? extends Number, String> skaiciai, Linksnis linksnis) {
		Forma f = new Forma(Poskyris.Pagrindinis, gimine, Skaicius.V, linksnis, Rusis.P);
	...
	public void testVirst1000KBigIntegers() {
		...
		smallNumbers.put(new BigInteger("652874203"), prefix + "trijų");
		smallNumbers.put(new BigInteger("652874201"), prefix + (gimine == Gimine.V ? "vieno" : "vienos"));
	...
	public void testVirst1000NBigIntegers() {
		...
		smallNumbers.put(new BigInteger("652874203"), prefix + "trims");
		smallNumbers.put(new BigInteger("652874201"), prefix + (gimine == Gimine.V ? "vienam" : "vienai"));
