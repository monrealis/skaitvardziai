...
import eu.vytenis.skaitvardziai.parser.antlr4.SkaitvardziaiFunctionParserBaseVisitor;
import eu.vytenis.skaitvardziai.parser.methods.MethodInvocation;
import eu.vytenis.skaitvardziai.skaiciai.SveikasisSkaicius;
import eu.vytenis.skaitvardziai.skaiciai.Trupmena;

class MethodInvocationVisitor extends SkaitvardziaiFunctionParserBaseVisitor<Void> {
	private String name;
